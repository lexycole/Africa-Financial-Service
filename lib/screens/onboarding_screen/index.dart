...
class OnboardingScreen extends StatelessWidget {
  ...
  final List<PageViewModel> pages = [
    ...
    PageViewModel(
        ...
        body:
            'To drive access to digital payment and online stores for businesses in the financially excluded area of the society.',
        footer: Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Container(
    ...
    PageViewModel(
        ...
        image: Center(
          child: Image.asset(
              'assets/onboarding_image/send_and_receive_assets.png'),
        ),
        decoration: const PageDecoration(
            titleTextStyle: TextStyle(
          fontSize: 25.0,
